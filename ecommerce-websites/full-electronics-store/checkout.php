...
if(isset($_POST['order'])){
    ...
    $address = 'Address ' . $_POST['street'] . ', ' . $_POST['city'] . ', ' . $_POST['state'] . ', ' . $_POST['country'] . ', ' . $_POST['zip_code'];
        ...
        <form action="" method="post">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="tel" name="phone" class="box" minlength="10" maxlength="10" placeholder="Enter Your Number" required>
                </div>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" name="street" class="box" placeholder="Enter Your Address" maxlength="20" required>
                </div>
                <div class="inputBox">
                    <span>City:</span>
                    <input type="text" name="city" class="box" placeholder="Enter Your Name" maxlength="50" required>
                </div>
                <div class="inputBox">
                    <span>State:</span>
                ...
                <div class="inputBox">
                    <span>Zip Code:</span>
                    <input type="text" name="zip_code" class="box" maxlength="10" placeholder="Zip Code" required>
                </div>
            </div>

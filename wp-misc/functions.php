...
function register_theme_styles(){
	...
	wp_register_style('mycustomcss', get_stylesheet_uri(), array(), false, 'all');
	wp_enqueue_style('mycustomcss');
}
add_action('wp_enqueue_scripts', 'register_theme_styles');

// Custom Header Shortcode
function custom_elementor_header(){
	?>
	<header class="header">
		<a href="<?php site_url(); ?>" class="logo"><i class="fa-solid fa-utensils"></i><span>Chef</span>Tae's<span>.</span></a>
...
add_shortcode('my_elementor_header', 'custom_elementor_header');
